...
import java_snippets._15_polymorphism.Dog;
...
public class _14_equals_hashcode_method {
    public static void main(String[] args) {
        ...
        // 3. contract between equals and hashCode works like:
        // - if hashCode for two objects is the same -> equals() can be the same
        // so, equals first check hashCode for two objects ->
        // if it's false -> return false
        // if it's true -> than compare it using equals()
    }
}
